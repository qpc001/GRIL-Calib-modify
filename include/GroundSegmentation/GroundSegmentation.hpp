...
typedef std::shared_ptr<travel::TravelGroundSeg<pcl::PointXYZI>> TravelGroundSegPtr;
typedef std::shared_ptr<const travel::TravelGroundSeg<pcl::PointXYZI>> TravelGroundSegConstPtr;
typedef std::shared_ptr<travel::ObjectCluster<pcl::PointXYZI>> ObjectClusterPtr;
typedef std::shared_ptr<const travel::ObjectCluster<pcl::PointXYZI>> ObjectClusterConstPtr;

typedef pcl::PointCloud<pcl::PointXYZI> CloudType;
...
void buildTravel(const ros::NodeHandle &nh, TravelGroundSegPtr &ground_seg, ObjectClusterPtr &object_seg)
{
  ...
  ground_seg.reset(new travel::TravelGroundSeg<pcl::PointXYZI>());
  ...
  object_seg.reset(new travel::ObjectCluster<pcl::PointXYZI>());
